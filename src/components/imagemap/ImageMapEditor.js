...
class ImageMapEditor extends Component {
    ...
    this.websocket.onmessage = (e) => {
        ...
        if (type === 'add') {
            this.canvasRef.handlers.add(target, false, true, false);
        } else if (type === 'modified') {
            const findObj = this.canvasRef.handlers.findById(target.id);
            this.canvasRef.handlers.setByPartial(findObj, target);
        }
